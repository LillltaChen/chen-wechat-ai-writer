...
| 步骤 | 动作 | 说明 |
|------|------|------|
| Step 1 | 接收选题 | 用户给话题，或 AI 生成 5 个候选选题 |
| Step 2 | 素材搜集 | 核心观点、案例、金句、反常识角度、读者痛点 |
| Step 3 | 结构拆解 | 分析 3 种爆款结构，推荐最适合的一种 |
| Step 4 | 生成大纲 | 标注字数、钩子位置、情绪节奏 |
| Step 5 | 写作正文 | 口语化、短句、去 AI 味，Markdown 输出 |
| Step 6 | 生成标题 | 5 种公式各 3 个，选 Top 3 推荐 |
| Step 7 | 封面提示词 | 输出 Midjourney / GPT-4o 可用的英文提示词 |
| Step 8 | 排版转 HTML | Markdown → 微信公众号 HTML 格式 |
| Step 9 | 推草稿箱 | 调用微信 API，一键进入后台 |
